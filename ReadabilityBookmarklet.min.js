...
!function(){var a=e('<div class="page" />')
t.empty().append(a)
for(var o=null,i=0;i<n.length;i++){var r
r=o?o+" "+n[i]:n[i],a.text(r),a.height()>e(window).height()?(a.text(o),a.clone().insertBefore(a),o=null):o=r}}()})}()})}
