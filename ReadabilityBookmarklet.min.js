...
t.empty().append(a)
for(var o="",i=e(window).height(),r=0,d=0,c="",p=0;p<n.length;p++)c=o+n[p],a.text(c),r++,r>100&&(!(d>100)||d/2<r)&&a.height()>i?(d=d>0&&d<r?d:r,r=0,a.text(o),a.clone().insertBefore(a),o=n[p]):o=c}()})}(),0)})}
