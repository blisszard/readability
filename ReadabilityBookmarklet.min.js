...
a.type="text/css",a.appendChild(document.createTextNode("div#pages{white-space: pre-wrap;} body{ margin:0px; } div.page {padding:0 8px 0 8px;} #pages .turn-page{ color:#fff; background-color:#383838; background-size:100% 100%; }")),document.getElementsByTagName("head")[0].appendChild(a)
var o=!1,i=function(e){var t=e(window).height()
e(window).width()
e("#pages").turn({display:"single",acceleration:!0,gradients:!1,duration:0,height:t,width:"100%",when:{turned:function(e,t){console.log(t)}}}),e("#pages").turn("disable",!0),o=!0}
loadScript(jQuerySrc),loadScript(turnSrc,function(){jQuery(function(e){e(window).ready(function(){i(e)}),e("#pages").on("touchend click",function(t){var n=e(window).width(),a=t.pageX
if(void 0===a){if(void 0===t.originalEvent||void 0===t.originalEvent.touches[0])return
a=t.originalEvent.touches[0].pageX,t.stopPropagation(),t.preventDefault()}a<=n/2?e("#pages").turn("previous"):e("#pages").turn("next")}),e(window).bind("keydown",function(t){37==t.keyCode?e("#pages").turn("previous"):39==t.keyCode&&e("#pages").turn("next")}),e(window).resize(function(){o&&e("#pages").turn("resize")}).resize()})}),document.body.innerHTML='<div id="pages">'+jQuery(content).text()+"</div>"
!function(){jQuery(function(e){var t=e("div#pages"),n=t.text().split(/( |\n+)/)
!function(){var a=e('<div class="page" style="font-size:1.2em"/>')
t.empty().append(a)
for(var o="",i=e(window).height(),r=0,d=0,c="",p=0;p<n.length;p++)c=o+n[p],a.text(c),r++,r>100&&(!(d>100)||d/2<r)&&a.height()>i?(d=d>0&&d<r?d:r,r=0,a.text(o),a.clone().insertBefore(a),o=n[p]):o=c}()})}()})}
